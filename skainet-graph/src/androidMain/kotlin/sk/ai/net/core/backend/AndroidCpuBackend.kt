...
/**
 * Android-specific implementation of the CPU backend.
 *
 * This backend provides optimized implementations of tensor operations for the Android platform.
 */
class AndroidCpuBackend : CpuBackend() {
    /**
     * The name of the backend.
     */
    override val name: String = "Android CPU"
