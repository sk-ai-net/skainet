...
/**
 * WebAssembly implementation of DiskBackedTensor.
 *
 * Since WebAssembly doesn't have direct file system access, this implementation
 * uses an in-memory array instead of a file. It simulates disk-backed storage
...
actual class DiskBackedTensor actual constructor(
     ...
     * In WebAssembly, this is just for compatibility and doesn't represent an actual file.
     */
     ...
     * In WebAssembly, this is a no-op since there's no actual disk storage.
     */
    actual fun flush() {
     ...
     * In WebAssembly, this is a no-op since there's no actual file to close.
     */
    actual fun close() {
        // No-op in WebAssembly
    }
