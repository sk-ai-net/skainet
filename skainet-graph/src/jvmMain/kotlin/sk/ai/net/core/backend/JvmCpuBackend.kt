...
/**
 * JVM-specific implementation of the CPU backend.
 *
 * This backend provides optimized implementations of tensor operations for the JVM platform.
 */
class JvmCpuBackend : CpuBackend() {
    /**
     * The name of the backend.
     */
    override val name: String = "JVM CPU"
