...
import sk.ai.net.core.tensor.shape.ShapeChecker
import kotlin.math.max

/**
 * A CPU-based implementation of the ComputeBackend interface.
 *
 * This backend executes tensor operations on the CPU using simple, straightforward
 * implementations. It is suitable for small-scale computations and as a reference
 * implementation for other backends.
 */
open class CpuBackend : ComputeBackend {
    /**
